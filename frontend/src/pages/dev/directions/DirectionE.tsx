...
/**
 * U3-SCRATCH-DASHBOARD-DIRECTIONS — direction E.
 *
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={mergeClasses(styles.page, styles.pageGrid)} style={{ padding: 0 }}>
        ...
        {/* ===== Support — one quiet line, not a card competing for attention ===== */}
        <section className={styles.areaSupport}>
          <Text className={styles.muted}>Need help? Our support team is available 24/7.</Text>
        </section>
      </div>
