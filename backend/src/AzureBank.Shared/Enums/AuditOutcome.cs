...
/// <summary>
/// What happened, for one audit event. Derived from the 26 existing security-event log sites rather
...
{
    /// <summary>
    /// The caller was refused; nothing was written to the business tables. 16 of the 26 sites,
