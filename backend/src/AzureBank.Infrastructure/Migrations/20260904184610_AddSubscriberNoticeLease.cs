...
namespace AzureBank.Infrastructure.Migrations
{
    ...
    /// (a claim reads through it), the concurrency token stays <c>DeliveredAt</c>. Both columns are
    ...
    /// marking is succeeded after its lease lapses, and that row goes out again — at-least-once, said
    /// in the ADR rather than implied away by a column.
    /// </para>
    /// </remarks>
    public partial class AddSubscriberNoticeLease : Migration
    {
        ...
        /// a row simply finds it owed again. No delivered notice, receipt or mark is touched.
        /// </remarks>
