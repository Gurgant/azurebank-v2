...
/// next. Measured against <c>RunbookSqlCorpus.json</c> — 3,017 statements, every one accepted
/// by SQL Server's own parser, and 377 sentences an operator runbook could hold — that pattern
/// missed 822 of the statements standing alone and reported 133 of the sentences: <i>"Grant the
...
/// </para>
/// <para>
/// <b>What it reaches, as numbers.</b> Of the corpus's 3,017 statements the scan reports 2,860,
