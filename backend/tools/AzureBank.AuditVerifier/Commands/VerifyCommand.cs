    ...
    private static string[] UncoveredWindow(AnchorCoverage coverage, long? highest)
    {
        ...
        */
        ...
        [
            ...
            "  walk checks the links, never the contiguity. Since the ring that is not only",
            "  Audit:ChainKey: a retired key answers for its own epoch, so its holder can do this",
            "  inside that epoch. Against anyone holding none of them the two are the same number.",
