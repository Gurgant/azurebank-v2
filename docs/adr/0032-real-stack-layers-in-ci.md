...
- **`contract-tests.yml` is untouched.** ~~Schemathesis and Bruno stay manual and non-gating~~;
  folding them in is a separate decision about what should block a merge. *(Half taken 2026-09-15:
