...
| [0029](0029-contract-conformance-gate.md) | 2026-08-10 (amendment; no PR named) · 2026-09-04, ADR-0041 · 2026-09-15, ADR-0043 (a note under Decision 1) | `test:contract:mock` ran in no CI job, so the title was half true; "the only thing the money handlers consult" is now true of the reveal alone; ADR-0043 added the document itself to the suite as a third party. |
